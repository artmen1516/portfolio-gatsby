...
function FeaturedCard({ project }) {
  return (
    <div className='max-w-xs md:max-w-none md:w-full lg:max-w-xs 4xl:max-w-sm max-h-full bg-gradient-to-r from-indigo-500 to-cyan-500 rounded-xl p-0.5'>
      <div className='flex flex-col gap-5 mx-auto p-5 rounded-xl bg-background min-h-full items-center'>
        ...
        <div className='flex flex-row w-full m-auto gap-3 text-textSecondary 4xl:text-xl'>
          <span className='px-3 text-textSecondary bg-dark font-bold rounded-full 4xl:text-xl'>{project.year}</span>
