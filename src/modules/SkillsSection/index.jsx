    ...
    <div>
      <div className='m-auto flex flex-col items-start p-5'>
        <div className='flex justify-between m-auto w-full text-left py-5'>
          <span className='text-xl md:text-2xl 4xl:text-5xl font-semibold text-textPrimary'>Skills</span>
        </div>
        ...
        <div className='w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]'>
          <div className='flex items-center justify-center md:justify-start animate-infinite-scroll'>
            {sanitySkills.skillsIcons.map((icon) =>
              <SkillsIcon key={icon._key} classes='text-5xl 4xl:text-6xl hover:text-cyan-500 hover:scale-[1.20] mx-2 md:mx-5 my-5' icon={icon.icon} size={icon.size} color={icon.hexColor} />
              )
            }
          </div>
